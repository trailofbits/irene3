...
import anvill.plugin.anvillpatchgraph.AnvillPatchGraphPlugin;
import ghidra.framework.options.Options;

public interface AnvillGraphLayoutOptions {

  String OWNER = AnvillPatchGraphPlugin.class.getSimpleName();
