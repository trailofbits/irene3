...
public abstract class AnvillGraphLayoutProvider
  ...
  public abstract anvill.plugin.anvillpatchgraph.layout.BBGraphLayout getAnvillGraphLayout(
      BasicBlockGraph graph, TaskMonitor monitor) throws CancelledException;
