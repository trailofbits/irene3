...
import anvill.plugin.anvillgraph.graph.jung.renderer.BasicBlockEdgeRenderer;
...
public abstract class AbstractBBGraphLayout extends
  ...
  @Override
  public BBGraphLayout cloneLayout(VisualGraph<BasicBlockVertex, BasicBlockEdge> newGraph) {
